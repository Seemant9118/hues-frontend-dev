        ...
        <DatePicker
            ...
            renderCustomHeader={({ date, changeYear, changeMonth, decreaseMonth, increaseMonth, prevMonthButtonDisabled, nextMonthButtonDisabled }) => (
                <div style={{ margin: 10, display: "flex", justifyContent: "center" }}>
                    <button className="text-lg font-bold p-1" onClick={decreaseMonth} disabled={prevMonthButtonDisabled}>
                        {"<"}
                    </button>
                    <select
                    ...
                    <button className="text-lg font-bold p-1" onClick={increaseMonth} disabled={nextMonthButtonDisabled}>
                        {">"}
                    </button>
                </div>
            )}
