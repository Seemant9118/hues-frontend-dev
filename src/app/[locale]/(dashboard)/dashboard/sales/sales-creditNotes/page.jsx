...
const SalesCreditNotes = () => {
  useMetaData('Hues! - Sales Credit Notes', 'HUES CREDITNOTES'); // dynamic title

  const translations = useTranslations('sales.sales-credit_notes');
  ...
  const onRowClick = (row) => {
    const isSaleCreditRead = row?.readTracker?.sellerIsRead || true;
