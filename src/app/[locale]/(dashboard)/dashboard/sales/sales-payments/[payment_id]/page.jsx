...
const PaymentDetails = () => {
  ...
  const paymentsOrdersBreadCrumbs = [
    ...
    },
    {
      ...
      path: `/dashboard/sales/sales-payments/${params.payment_id}`,
      show: true, // Always show
    },
  ];

  const { data: paymentsDetails, error } = useQuery({
    queryKey: [paymentApi.getPaymentDetails.endpointKey, params.payment_id],
  ...
  if (
    ...
    hasPermission('permission:sales-payments-action')
  ) {
