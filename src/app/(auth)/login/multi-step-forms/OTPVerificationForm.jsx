...
export default function OTPVerificationForm({ setCurrStep }) {
    ...
    return (
        <form onSubmit={handleVerifiyOTP} className="border border-[#E1E4ED] p-10 flex flex-col justify-center items-center gap-5 h-[500px] w-[450px] bg-white z-20 rounded-md">
