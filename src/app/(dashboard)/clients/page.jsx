...
const ClientPage = () => {
  ...
  const ClientsEmptyStageData = {
    ...
    subHeading: "Features",
    subItems: [
      { id: 1, icon:<UserPlus size={14}/>,subItemtitle: `Easily add client details to your database.` },
      { id: 2, icon:<Key size={14}/>,subItemtitle: `Offer inventory directly to clients with full product access.` },
      { id: 3, icon:<BookCheck size={14}/>,subItemtitle: `Keep clients updated, fostering transparency and trust.` },
      { id: 4, icon:<BookUser size={14}/>,subItemtitle: `Listed clients get automatic catalog access, simplifying sales.` },
    ],
  };
